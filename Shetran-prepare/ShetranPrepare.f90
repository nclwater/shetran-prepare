    program ShetranPrepare
        ...
        write(*,*)  '***************'
        write(*,*) 
        write(*,*)  'This executable reads an XML (library) file together with the corresponding map'  
        write(*,*)  ' (asc format) and time series files. It produces the SHETRAN input files'    
        write(*,*) 
